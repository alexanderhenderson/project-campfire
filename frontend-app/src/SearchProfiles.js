                                ...
                                <div className="col-sm-4 padding_bottom" key={user.id}>
                                    ...
                                    onClick={() => {
                                        navigate(`/profile/${user.id}/`)
                                            ...
                                            <img src={user?.profile_photo || "https://t3.ftcdn.net/jpg/03/46/83/96/360_F_346839683_6nAPzbhpSkIpb8pmAwufkC7c5eD7wYws.jpg"} className="card-img-top crop-image" alt="profilephoto" />
