...
export default function MemberMatcher() {
  ...
  return(
    ...
    <div className="px-4 py-5 my-5 text-center">
      ...
      <div><small>Build your tribe</small></div>
      {/* New Div */}
      ...
      <div hidden={ (KindlerList.length > 0) ? false : true }>
        <div className="card mb-3 shadow h-100">
              <img className="kindle-card" src={KindlerList?.[0]?.profile_photo || 
              ...
              <div className="card-body">
                ...
                <button className="btn btn-success" onClick={click}> Test friend[0] state </button>



              </div>
              <div className="card-footer">
                Location: {KindlerList?.[0]?.city}
                 {" "}-{" "}
                 {KindlerList?.[0]?.state}
             </div>
            </div>
          ...
          <div className="col-sm-4" key={KindlerUser.id}>
            <div className="card mb-3 shadow h-100">
              ...
              <div className="card-body">
                ...
                <button type="button" className="btn btn-warning"> Add to Friend's List </button>
              </div>
              <div className="card-footer">
                {KindlerUser.city}
                 -
