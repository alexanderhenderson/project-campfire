        ...
        return (
            <div>
                ...
                <main className='picture-grid'>
                    <div className='picture-grid'>
                        <img className='picture-card' src={peoplehands} alt="peoplehands" />
                        <img className='picture-card' src={climbingfriends} alt="climbingfriends" />
                        <img className='picture-card' src={people1} alt="people1" />
                    </div>
                </main>
